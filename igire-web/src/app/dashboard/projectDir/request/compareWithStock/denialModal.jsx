...
const DenyPurchaseModal = ({ isOpen, onClose, onApprove }) => {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-lg bg-[#F8F8F8] items-center border-none rounded-xl p-6">
                <DialogHeader>
                    <DialogTitle className="text-center text-xl font-bold">Deny Purchase</DialogTitle>
                </DialogHeader>
                ...
                <DialogFooter className="flex justify-star mt-6">
                    <Button onClick={handleDeny} className="bg-[#0FA958] text-white px-4 py-2">Comfirm</Button>
...
export default DenyPurchaseModal;
